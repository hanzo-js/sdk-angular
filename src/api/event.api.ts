...
export interface EventApiGetEventErrorsRequestParams {
...
export interface EventApiGetEventInsightsEventsRequestParams {
    /** Limit is how many rows to return, newest first. Default 50, maximum 200; a value at or below zero, or one that is not a number, takes the default. */
    limit?: number;
}

export interface EventApiGetEventOverviewRequestParams {
...
export interface EventApiGetEventTimeseriesRequestParams {
    /** Range is a relative window: a count and a unit — 24h, 7d, 90d, any &lt;N&gt;h or &lt;N&gt;d — or day, week, month, all. Default 24h. Ignored when both start and end are given. An unknown value, or one past the 730-day horizon, is a 400. */
    range?: string;
    /** Start is the inclusive lower bound of a custom window, RFC3339. Requires end. */
    start?: string;
...
export interface EventApiGetEventTopRequestParams {
    /** Range is a relative window: a count and a unit — 24h, 7d, 90d, any &lt;N&gt;h or &lt;N&gt;d — or day, week, month, all. Default 24h. Ignored when both start and end are given. An unknown value, or one past the 730-day horizon, is a 400. */
    range?: string;
    /** Start is the inclusive lower bound of a custom window, RFC3339. Requires end. */
    start?: string;
...
export interface EventApiPostEventReplayRequestParams {
...
export class EventApi extends BaseService {
     ...
     */
    public getEventErrors(requestParameters?: EventApiGetEventErrorsRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<ErrorList>;
    public getEventErrors(requestParameters?: EventApiGetEventErrorsRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<ErrorList>>;
    public getEventErrors(requestParameters?: EventApiGetEventErrorsRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<ErrorList>>;
    public getEventErrors(requestParameters?: EventApiGetEventErrorsRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/v1/event/errors`;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getEventHealth(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HealthReport>;
    public getEventHealth(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<HealthReport>>;
    public getEventHealth(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<HealthReport>>;
    public getEventHealth(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/v1/event/health`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getEventInsightsEvents(requestParameters?: EventApiGetEventInsightsEventsRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<EventList>;
    public getEventInsightsEvents(requestParameters?: EventApiGetEventInsightsEventsRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<EventList>>;
    public getEventInsightsEvents(requestParameters?: EventApiGetEventInsightsEventsRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<EventList>>;
    public getEventInsightsEvents(requestParameters?: EventApiGetEventInsightsEventsRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        const limit = requestParameters?.limit;
        ...
        let localVarPath = `/v1/event/insights/events`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getEventInsightsHealth(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<InsightsStatus>;
    public getEventInsightsHealth(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<InsightsStatus>>;
    public getEventInsightsHealth(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<InsightsStatus>>;
    public getEventInsightsHealth(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/v1/event/insights/health`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getEventOverview(requestParameters?: EventApiGetEventOverviewRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<Overview>;
    public getEventOverview(requestParameters?: EventApiGetEventOverviewRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Overview>>;
    public getEventOverview(requestParameters?: EventApiGetEventOverviewRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Overview>>;
    public getEventOverview(requestParameters?: EventApiGetEventOverviewRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/v1/event/overview`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getEventTagJs(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/javascript', context?: HttpContext, transferCache?: boolean}): Observable<Blob>;
    public getEventTagJs(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/javascript', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Blob>>;
    public getEventTagJs(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/javascript', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Blob>>;
    public getEventTagJs(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/javascript', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/v1/event/tag.js`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getEventTimeseries(requestParameters?: EventApiGetEventTimeseriesRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<Timeseries>;
    public getEventTimeseries(requestParameters?: EventApiGetEventTimeseriesRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Timeseries>>;
    public getEventTimeseries(requestParameters?: EventApiGetEventTimeseriesRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Timeseries>>;
    public getEventTimeseries(requestParameters?: EventApiGetEventTimeseriesRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        const range = requestParameters?.range;
        const start = requestParameters?.start;
        const end = requestParameters?.end;
        ...
        let localVarPath = `/v1/event/timeseries`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getEventTop(requestParameters?: EventApiGetEventTopRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<Top>;
    public getEventTop(requestParameters?: EventApiGetEventTopRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Top>>;
    public getEventTop(requestParameters?: EventApiGetEventTopRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Top>>;
    public getEventTop(requestParameters?: EventApiGetEventTopRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        const range = requestParameters?.range;
        const start = requestParameters?.start;
        const end = requestParameters?.end;
        const limit = requestParameters?.limit;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public postEventReplay(requestParameters?: EventApiPostEventReplayRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<CaptureResult>;
    public postEventReplay(requestParameters?: EventApiPostEventReplayRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<CaptureResult>>;
    public postEventReplay(requestParameters?: EventApiPostEventReplayRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<CaptureResult>>;
    public postEventReplay(requestParameters?: EventApiPostEventReplayRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/v1/event/replay`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<CaptureResult>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
