...
export const APIS = [AccountApi, AdApi, AffiliateApi, AgentsApi, AiApi, AllowanceApi, AskApi, AuditApi, AuthorApi, AuthzApi, AutoApi, BaseApi, BenchmarkApi, BillingApi, BlueprintApi, BooksApi, BotApi, CampaignApi, CaptableApi, CatalogApi, ChannelsApi, CiApi, CloudflareApi, CodeApi, CommerceApi, CompanyApi, ComplianceApi, ContentApi, CrawlApi, DataroomApi, DatasetApi, DeployApi, DestinationApi, DnsApi, DomainApi, EngineApi, EntitlementApi, EsignApi, EvalApi, EventApi, ExecApi, ExperimentApi, ExplorerApi, FlagsApi, FlowApi, FrameworkApi, FunctionsApi, GatewayApi, GitApi, GraphApi, GuideApi, HelpApi, IamApi, IndexApi, IngressApi, IntegrationsApi, KmsApi, KnowledgeApi, KvApi, LabelApi, LeaderboardApi, LegalApi, LicensingApi, LinkApi, LspApi, MarketApi, MarketingApi, MarketplaceApi, MeetApi, MetricsApi, MlApi, MqApi, NetworkApi, NodeApi, NotifyApi, O11yApi, OpenapiApi, PlanApi, PlatformApi, PrefApi, PricingApi, ProjectsApi, PromptApi, ProvisioningApi, PubsubApi, ReferenceApi, ReferralApi, RegistryApi, RiskApi, S3Api, SandboxApi, SbomApi, SearchApi, SecurityApi, SeoApi, SettingsApi, ShareApi, SocialApi, SpaceApi, StandingApi, SyncApi, TasksApi, TaxonomyApi, TeamApi, TelApi, TemplateApi, TodoApi, ToolsApi, TranslateApi, TreasuryApi, TrustApi, UsageApi, ValidatorApi, VisorApi, WalletApi, Web3Api, WebhookApi, WebsearchApi, WorldApi, X402Api];
